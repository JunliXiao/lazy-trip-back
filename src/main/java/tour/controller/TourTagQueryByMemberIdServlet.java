...
@WebServlet("/tourTagQueryByMemberId")
public class TourTagQueryByMemberIdServlet extends HttpServlet{
...
//			tourTagVO.setTourId(Integer.valueOf(tourId));
			...
			final Set<String> resultSet = service.tourQueryByMemberId(tourTagVO);
			System.out.println(tourTagVO.toString());
