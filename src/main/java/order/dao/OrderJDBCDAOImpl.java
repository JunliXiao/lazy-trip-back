...
public class OrderJDBCDAOImpl implements OrderDAOInterface {
    ...
    private static final String CREATE_ORDER_DETAIL =
            "INSERT INTO lazy.order_detail (order_id, roomtype_id, roomtype_name, roomtype_person, order_detail_room_price, order_detail_room_quantity)\n" +
                    "VALUES (?, ?, ?, ?, ?, ?);";
    ...
    private static final String SELECT_FIND_ORDER_DETAIL_BY_ORDER_ID =
            "SELECT order_detail_id, order_id, roomtype_id, roomtype_name, roomtype_person, order_detail_room_price, order_detail_room_quantity FROM lazy.order_detail WHERE order_id = ?;";
    //====================================================================================
